...
STEP_OUT = OUT_DIR / "blood_sorting_robot_cadquery_rough_layout_v2.step"
CSV_OUT = OUT_DIR / "blood_sorting_robot_cadquery_rough_layout_v2_validation.csv"
REPORT_OUT = ROOT / "reports" / "cadquery_rough_assembly_v2_report.md"
...
def main() -> int:
    ...
    assembly = cq.Assembly(name="blood_sorting_robot_cadquery_rough_layout_v2")
