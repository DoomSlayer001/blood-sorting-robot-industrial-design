...
MODULE_STEP_OUT = OUT_DIR / "blood_sorting_robot_enclosure_guard_module_v1_1.step"
MODULE_VALIDATION_OUT = OUT_DIR / "blood_sorting_robot_enclosure_guard_module_v1_1_validation.csv"
MODULE_COLOR_MANIFEST_OUT = OUT_DIR / "blood_sorting_robot_enclosure_guard_module_v1_1_color_manifest.csv"
ACCESSIBILITY_CSV_OUT = OUT_DIR / "blood_sorting_robot_enclosure_guard_module_v1_1_accessibility_check.csv"

PREVIEW_STEP_OUT = OUT_DIR / "blood_sorting_robot_v7_3a_enclosure_preview_v1_1.step"
PREVIEW_VALIDATION_OUT = OUT_DIR / "blood_sorting_robot_v7_3a_enclosure_preview_v1_1_validation.csv"
PREVIEW_AUDIT_OUT = OUT_DIR / "blood_sorting_robot_v7_3a_enclosure_preview_v1_1_interference_audit.csv"
PREVIEW_COLOR_MANIFEST_OUT = OUT_DIR / "blood_sorting_robot_v7_3a_enclosure_preview_v1_1_color_manifest.csv"

REPORT_OUT = REPORT_DIR / "stage_7a3a_enclosure_guard_module_v1_1_report.md"
...
guard_height_mm = 430.0
front_panel_height_mm = 90.0
side_panel_height_mm = 260.0
rear_panel_height_mm = 300.0

frame_profile_size_mm = 18.0
...
door_frame_height_mm = 260.0
door_frame_profile_mm = 10.0
...
class EnclosureGuardModule:
    ...
    def aluminum_frame(self):
        ...
        rows = [
            ...
            box_component("enclosure_bottom_front_left_stub", "AluminumFrameModule", (120.0, profile, profile), (-530.0, self.y_front, z_bottom), "aluminum_frame", "front rail segmented for operator openings"),
            box_component("enclosure_bottom_front_center_stub", "AluminumFrameModule", (95.0, profile, profile), (-15.0, self.y_front, z_bottom), "aluminum_frame", "front rail segmented for manual-review opening"),
            box_component("enclosure_bottom_front_right_stub", "AluminumFrameModule", (120.0, profile, profile), (530.0, self.y_front, z_bottom), "aluminum_frame", "front rail segmented for operator openings"),
            ...
            box_component("enclosure_front_upper_left_beam", "AluminumFrameModule", (220.0, profile, profile), (-470.0, self.y_front, z_top), "aluminum_frame", "horizontal front top beam segment over input-side opening"),
            box_component("enclosure_front_upper_center_beam", "AluminumFrameModule", (130.0, profile, profile), (-10.0, self.y_front, z_top), "aluminum_frame", "horizontal front top beam segment between access openings"),
            box_component("enclosure_front_upper_right_beam", "AluminumFrameModule", (220.0, profile, profile), (470.0, self.y_front, z_top), "aluminum_frame", "horizontal front top beam segment over output-side opening"),
        ]
        return rows
    ...
    def transparent_panels(self):
        ...
        return [
            box_component("enclosure_rear_transparent_panel", "TransparentPanelModule", (1040.0, panel_thickness_mm, rear_panel_height_mm), (0.0, rear_y, panel_z_rear), "transparent_panel_clean", "lower, lighter rear transparent PC/acrylic panel"),
            box_component("enclosure_left_transparent_panel", "TransparentPanelModule", (panel_thickness_mm, 430.0, side_panel_height_mm), (left_x, 170.0, panel_z_side), "transparent_panel_clean", "reduced-height left transparent side panel"),
            box_component("enclosure_right_transparent_panel", "TransparentPanelModule", (panel_thickness_mm, 430.0, side_panel_height_mm), (right_x, 170.0, panel_z_side), "transparent_panel_clean", "reduced-height right transparent side panel"),
            box_component("enclosure_front_left_low_panel", "TransparentPanelModule", (64.0, panel_thickness_mm, front_panel_height_mm), (-562.0, self.y_front + 2.0, front_z), "transparent_panel_clean", "short front low panel, does not cover input access"),
            box_component("enclosure_front_center_low_panel", "TransparentPanelModule", (58.0, panel_thickness_mm, front_panel_height_mm), (-8.0, self.y_front + 2.0, front_z), "transparent_panel_clean", "short front low divider panel, manual review remains accessible"),
            box_component("enclosure_front_right_low_panel", "TransparentPanelModule", (64.0, panel_thickness_mm, front_panel_height_mm), (562.0, self.y_front + 2.0, front_z), "transparent_panel_clean", "short front low panel, does not cover output access"),
        ]
    ...
    def access_doors(self):
        ...
        rows.append(handle_component("enclosure_input_door", -150.0, y, 150.0))
        rows.append(handle_component("enclosure_output_door", 490.0, y, 150.0))
        return rows

    def manual_review_access(self):
        y = self.y_front - 6.0
        rows = frame_rect_components("enclosure_manual_review_access_opening", "ManualReviewAccessModule", -180.0, y, 8.0, front_center_access_width_mm, 150.0, 10.0, "access_door_frame", "simple manual_review front access opening")
        rows.append(handle_component("enclosure_manual_review_access", -90.0, y, 84.0))
        return rows

    def top_open_frame(self):
        profile = frame_profile_size_mm
        z = guard_height_mm - profile / 2.0
        return [
            box_component("enclosure_top_open_front_rectangular_rail", "TopOpenFrameModule", (1060.0, profile, profile), (0.0, self.y_front, z), "access_door_frame", "horizontal rectangular top front rail only, no roof panel"),
            box_component("enclosure_top_open_rear_rectangular_rail", "TopOpenFrameModule", (1060.0, profile, profile), (0.0, self.y_rear, z), "access_door_frame", "horizontal rectangular top rear rail only"),
            box_component("enclosure_top_open_left_rectangular_rail", "TopOpenFrameModule", (profile, 820.0, profile), (self.x_left, 0.0, z), "access_door_frame", "horizontal rectangular top left rail only"),
            box_component("enclosure_top_open_right_rectangular_rail", "TopOpenFrameModule", (profile, 820.0, profile), (self.x_right, 0.0, z), "access_door_frame", "horizontal rectangular top right rail only"),
        ]
...
def build_enclosure_only() -> tuple[cq.Assembly, list[object], list[dict[str, object]]]:
    assembly = cq.Assembly(name="blood_sorting_robot_enclosure_guard_module_v1_1")
...
def build_preview() -> tuple[cq.Assembly, list[object], list[dict[str, object]], list[dict[str, object]]]:
    assembly = cq.Assembly(name="blood_sorting_robot_v7_3a_enclosure_preview_v1_1")
    manifest_rows: list[dict[str, object]] = []
...
def accessibility_rows() -> list[dict[str, str]]:
    return [
        ...
        {"item": "rectangular_guard_frame", "check_status": "pass", "notes": "v1.1 uses vertical posts and horizontal rectangular top/perimeter rails only."},
        {"item": "no_sloped_roof", "check_status": "pass", "notes": "No sloped roof, tilted panel, or trapezoid cover geometry is generated."},
        {"item": "guard_panels_not_covering_racks", "check_status": "pass", "notes": "Transparent panels are limited to rear/side/short front-low positions and do not cover rack tops."},
    ]
