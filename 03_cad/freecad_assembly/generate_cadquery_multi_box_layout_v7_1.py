...
STEP_OUT = OUT_DIR / "blood_sorting_robot_cadquery_multi_box_layout_v7_1.step"
CSV_OUT = OUT_DIR / "blood_sorting_robot_cadquery_multi_box_layout_v7_1_validation.csv"
AUDIT_CSV_OUT = OUT_DIR / "blood_sorting_robot_cadquery_multi_box_layout_v7_1_interference_audit.csv"
COLOR_MANIFEST_OUT = OUT_DIR / "blood_sorting_robot_cadquery_multi_box_layout_v7_1_color_manifest.csv"
REPORT_OUT = REPORT_DIR / "cadquery_multi_box_layout_v7_1_report.md"
...
def main() -> int:
    ...
    assembly = cq.Assembly(name="blood_sorting_robot_cadquery_multi_box_layout_v7_1")
    manifest_rows = []
